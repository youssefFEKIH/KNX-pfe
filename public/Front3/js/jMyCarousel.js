(function ( $ ) {                  // Compliant with jquery.noConflict()
    $.fn.jMyCarousel = function(o) {   
        o = $.extend({
            ...
            evtStart : 'mouseout',	// start event that we want for the animation (click, mouseover, mousedown, etc..)
            evtStop : 'mouseover',	// stop event that we want for the animation (blur, mouseout, mouseup, etc..)
